SRCS= main.c parsing/tokenizing.c parsing/tokenizing2.c parsing/lexing.c parsing/utils.c parsing/utils2.c parsing/utils3.c parsing/utils4.c parsing/utils5.c\
	...
	execution/export2.c execution/export3.c execution/env.c execution/exit.c execution/pipe.c execution/export.c execution/utils2.c shlvl_init.c env_init.c
OBJS = $(SRCS:%.c=%.o)
HEADER = minishell.h 
